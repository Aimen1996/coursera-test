...
class Encoder(nn.Module):
    def __init__(self, attn_layers, conv_layers=None, norm_layer=None):
        ...
        # print('attn_laysr',self.attn_layers)
        # exit()
        self.conv_layers = nn.ModuleList(conv_layers) if conv_layers is not None else None    #none
    ...
    def forward(self, x, attn_mask=None, tau=None, delta=None):     #x,tau,delta, #attn_mask=none
        # x [B, L, D]
        attns = []
